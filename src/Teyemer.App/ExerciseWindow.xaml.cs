...
public partial class ExerciseWindow : Window
{
 ...
 public ExerciseWindow(int seconds) { InitializeComponent(); ThemeService.Attach(this); _endsAt = DateTimeOffset.Now.AddSeconds(seconds); _timer.Tick += Tick; _timer.Start(); Tick(null, EventArgs.Empty); }
